...
class Word:
    ...
    def search(self):
        if self.letters[0] != None:
            match(self.letters[0]):
                case 'a': self.match_word(awords)  
                case 'ą': self.match_word(ąwords)
                case 'b': self.match_word(bwords)
                case 'c': self.match_word(cwords)
                case 'ć': self.match_word(ćwords)
                case 'd': self.match_word(dwords)
                case 'e': self.match_word(ewords)
                case 'ę': self.match_word(ęwords)
                case 'f': self.match_word(fwords)
                case 'g': self.match_word(gwords)
                case 'h': self.match_word(hwords)
                case 'i': self.match_word(iwords)
                case 'j': self.match_word(jwords)
                case 'k': self.match_word(kwords)
                case 'l': self.match_word(lwords)
                case 'ł': self.match_word(łwords)
                case 'm': self.match_word(mwords)
                case 'n': self.match_word(nwords)
                case 'ń': self.match_word(ńwords)
                case 'o': self.match_word(owords)
                case 'ó': self.match_word(ówords)
                case 'p': self.match_word(pwords)
                case 'q': self.match_word(qwords)
                case 'r': self.match_word(rwords)
                case 's': self.match_word(swords)
                case 'ś': self.match_word(śwords)
                case 't': self.match_word(twords)
                case 'u': self.match_word(uwords)
                case 'v': self.match_word(vwords)
                case 'w': self.match_word(wwords)
                case 'x': self.match_word(xwords)
                case 'y': self.match_word(ywords)
                case 'z': self.match_word(zwords)
                case 'ź': self.match_word(źwords)
                case 'ż': self.match_word(żwords)
                case _: print('Unknown letter')
        else:
    ...
    def match_word(self, words):
        ...
        if self.noAvaliable:
            valid_words = [word for word in valid_words if all(
                letter not in self.remove_positions(word, [i for i, l in enumerate(self.letters) if l == letter])
